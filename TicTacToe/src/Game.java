...
public abstract class Game 
{
	...
	public void play()
	{
		...
		initialize(false); ///CUZ EKBAR INIT ALREADY 
		...
		while(!isFinished())
		{
			...
			turn = (turn+1)%2;//next jon er turn bujhate
		}
		/*null pointer niye jhamela hocche bole comment out kortesi*/
		if (winner != null)
